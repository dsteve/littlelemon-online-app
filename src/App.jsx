...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/reservation"
        element={<Page children={<Reservation selectedForm={bookingFormEnum.ORIGINAL} />} />}
      />
      <Route
        path="/reservation/capstone-view"
        element={<Page children={<Reservation selectedForm={bookingFormEnum.CAPSTONE} />} />}
      />
