          ...
          {[
            {
              ...
              picture: greeksalad,
              description:
                "The famous green salad of crispy lettuce, peppers, olives and our Chicago style feta cheese, garnished with crunchy garlic and rosemary croutons.",
            },
            {
              dish: "Bruschetta",
              price: "5.99",
            ...
            <div key={idx + 1} className={`col-start-${idx+2} px-5 mt-20 mb-10`}>
              <HighlightCard
                dish={item.dish}
                price={item.price}
